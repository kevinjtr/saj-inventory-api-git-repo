...
module.exports = {
    ...
    eng4900DatabaseColNames: {
        'id':{name:'form_id',type:'string'},
        'requestedAction':{name:'requested_action',type:'string'},
        'losingHra': {name:"losing_hra_num",type:'string'},
        'losingHraName': {name:"losing_hra_full_name",type:'string'},
        'gainingHra':{name:'gaining_hra_num',type:'string'},
